export const helpData = [
  {
    ...
    content:
      'Our Customer Experience Team is available 7 days a week and we offer 2 ways to get in contact. We try to reply quickly, so you need not to wait too long for a response!.',
  },
  {
    id: '2',
