export const privacyPolicy = [
  ...
  },
  {
    ...
    description:
      '<p>Customer are advised to read and understand our Privacy Policy carefully, as by accessing the website/app you agree to be bound by the terms and conditions of the Privacy Policy and consent to the collection, storage and use of information relating to you as provided herein.</p><p>If you do not agree with the terms and conditions of our Privacy Policy, including in relation to the manner of collection or use of your information, please do not use or access the website/app.</p>',
  },
  {
    id: '8',
  ...
  },
  {
    ...
    title: 'Contact us',
    description:
      '<p>We are always happy to chat. A good way to reach us here. <a href="/contact-us" class="underline hover:text-brand-dark hover:no-underline">Contact us</a></p>',
  },
];
